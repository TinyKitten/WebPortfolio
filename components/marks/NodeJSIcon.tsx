...
const NodeJSIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <g clipPath="url(#nodejs-a)" transform="translate(-78.306 -164.016)">
      <path
        fill="url(#nodejs-b)"
        d="M331.363 246.793l-118.715-58.19-60.87 124.174L270.49 370.97zm0 0"
      />
    </g>
    <g clipPath="url(#nodejs-c)" transform="translate(-78.306 -164.016)">
      <path
        fill="url(#nodejs-d)"
        d="M144.07 264.004l83.825 113.453 110.86-81.906-83.83-113.45zm0 0"
      />
    </g>
    <g clipPath="url(#nodejs-e)" transform="translate(-78.306 -164.016)">
      <path fill="url(#nodejs-f)" d="M197.02 225.934v107.43h91.683v-107.43zm0 0" />
    </g>
  </svg>
);
